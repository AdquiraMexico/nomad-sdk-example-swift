...
} EmvSwipeEncryptionMethod; //Added in 2.9.0-Beta1
...
@property (nonatomic, getter=isDebugLogEnabled, setter=setDebugLogEnabled:) BOOL debugLogEnabled; //Added in 2.9.0-Beta1
